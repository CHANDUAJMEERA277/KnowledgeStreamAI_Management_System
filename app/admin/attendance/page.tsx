    ...
    <div className="flex items-center justify-center h-[75vh]">
      ...
      <div className="max-w-xl w-full bg-slate-900 border border-slate-800 rounded-2xl p-10 text-center">
        ...
        <p className="text-slate-400 mt-4 text-lg">
          Attendance Management is currently under development.
        </p>

        <p className="text-slate-500 mt-2">
          This feature will allow administrators to monitor employee attendance,
          working hours, and daily check-ins.
        </p>
